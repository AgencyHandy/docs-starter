---
title: "حقول العملاء المحتملين المخصصة: التقاط بيانات إضافية"
sidebarTitle: "حقول العملاء المحتملين المخصصة"
description: "أنشئ وأدر الحقول المخصصة للعملاء المحتملين في Workspace Config."
---
...
With [AgencyHandy MCP](/ar/integrations/claude-cursor-mcp) (`agencyhandy-mcp@1.5+`):
...
See [Client Custom Fields](/ar/crm/client-custom-fields) for defining client-side fields.
...
- [Leads](/ar/crm/leads) — pipeline, email, and conversion
- [Client Custom Fields](/ar/crm/client-custom-fields) — fields that appear on client profiles
- [Clients](/ar/crm/clients) — client list, import, and portal access
- [Claude & Cursor MCP](/ar/integrations/claude-cursor-mcp) — fill fields from AI tools
