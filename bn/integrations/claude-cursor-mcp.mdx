...
| Assign tickets and other team work | Filling **lead** or **client custom field** values |
| Create leads | — |
| Send invoices and mark invoices paid | — |

MCP supports both reading your workspace and taking actions (create, assign, send, update) with your API key. Client chat replies and custom field values are not exposed through MCP yet — define fields in **Workspace Config** → **Custom Fields** and fill them on lead or client profiles in AgencyHandy.
...
- [Lead Custom Fields](/bn/crm/lead-custom-fields) · [Client Custom Fields](/bn/crm/client-custom-fields)
