---
title: "Vlastní pole leadů: zachyťte další data o prospektech"
sidebarTitle: "Vlastní pole leadů"
description: "Vytvářejte a spravujte vlastní pole pro leady ve Workspace Config."
---
...
With [AgencyHandy MCP](/cs/integrations/claude-cursor-mcp) (`agencyhandy-mcp@1.5+`):
...
See [Client Custom Fields](/cs/crm/client-custom-fields) for defining client-side fields.
...
- [Leads](/cs/crm/leads) — pipeline, email, and conversion
- [Client Custom Fields](/cs/crm/client-custom-fields) — fields that appear on client profiles
- [Clients](/cs/crm/clients) — client list, import, and portal access
- [Claude & Cursor MCP](/cs/integrations/claude-cursor-mcp) — fill fields from AI tools
