---
title: "Client-tilpassede felter: spor ekstra client-detaljer"
sidebarTitle: "Client-tilpassede felter"
description: "Opret og administrer tilpassede felter for clients i Workspace Config."
---
...
With [AgencyHandy MCP](/da/integrations/claude-cursor-mcp) (`agencyhandy-mcp@1.5+`):
...
See [Lead Custom Fields](/da/crm/lead-custom-fields) for defining lead-side fields.
...
- [Clients](/da/crm/clients) — create, import, export, and portal access
- [Lead Custom Fields](/da/crm/lead-custom-fields) — fields on prospects before conversion
- [Leads](/da/crm/leads) — pipeline and convert to client
- [Claude & Cursor MCP](/da/integrations/claude-cursor-mcp) — fill fields from AI tools
