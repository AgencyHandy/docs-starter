---
title: "Lead-tilpassede felter: fang ekstra prospekt-data"
sidebarTitle: "Lead-tilpassede felter"
description: "Opret og administrer tilpassede felter for leads i Workspace Config."
---
...
See [Client Custom Fields](/da/crm/client-custom-fields) for defining client-side fields.
...
- [Leads](/da/crm/leads) — pipeline, email, and conversion
- [Client Custom Fields](/da/crm/client-custom-fields) — fields that appear on client profiles
- [Clients](/da/crm/clients) — client list, import, and portal access
