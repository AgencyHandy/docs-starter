---
title: "Client-Custom-Fields: Zusätzliche Client-Details erfassen"
sidebarTitle: "Client-Custom-Fields"
description: "Erstellen und verwalten Sie Custom Fields für Clients in Workspace Config, um Vertragskonditionen, Branchen-Tags, bevorzugte Kanäle und weitere Daten über das Standardprofil hinaus zu speichern."
---
...
With [AgencyHandy MCP](/de/integrations/claude-cursor-mcp) (`agencyhandy-mcp@1.5+`):
...
See [Lead Custom Fields](/de/crm/lead-custom-fields) for defining lead-side fields.
...
- [Clients](/de/crm/clients) — create, import, export, and portal access
- [Lead Custom Fields](/de/crm/lead-custom-fields) — fields on prospects before conversion
- [Leads](/de/crm/leads) — pipeline and convert to client
- [Claude & Cursor MCP](/de/integrations/claude-cursor-mcp) — fill fields from AI tools
