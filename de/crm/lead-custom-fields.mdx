---
title: "Lead-Custom-Fields: Zusätzliche Prospect-Daten erfassen"
sidebarTitle: "Lead-Custom-Fields"
description: "Erstellen und verwalten Sie Custom Fields für Leads in Workspace Config, damit Ihr Team Branche, Budget, Quellen und weitere Daten über die Standard-CRM-Felder hinaus erfasst."
---
...
See [Client Custom Fields](/de/crm/client-custom-fields) for defining client-side fields.
...
- [Leads](/de/crm/leads) — pipeline, email, and conversion
- [Client Custom Fields](/de/crm/client-custom-fields) — fields that appear on client profiles
- [Clients](/de/crm/clients) — client list, import, and portal access
