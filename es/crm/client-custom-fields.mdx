...
With [AgencyHandy MCP](/es/integrations/claude-cursor-mcp) (`agencyhandy-mcp@1.5+`):
...
See [Lead Custom Fields](/es/crm/lead-custom-fields) for defining lead-side fields.
...
- [Clients](/es/crm/clients) — create, import, export, and portal access
- [Lead Custom Fields](/es/crm/lead-custom-fields) — fields on prospects before conversion
- [Leads](/es/crm/leads) — pipeline and convert to client
- [Claude & Cursor MCP](/es/integrations/claude-cursor-mcp) — fill fields from AI tools
