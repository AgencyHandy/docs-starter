...
See [Client Custom Fields](/es/crm/client-custom-fields) for defining client-side fields.
...
- [Leads](/es/crm/leads) — pipeline, email, and conversion
- [Client Custom Fields](/es/crm/client-custom-fields) — fields that appear on client profiles
- [Clients](/es/crm/clients) — client list, import, and portal access
