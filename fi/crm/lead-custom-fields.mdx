---
title: "Lead-mukautetut kentät: tallenna lisätietoja"
sidebarTitle: "Lead-mukautetut kentät"
description: "Luo ja hallitse lead-mukautettuja kenttiä Workspace Configissa."
---
...
With [AgencyHandy MCP](/fi/integrations/claude-cursor-mcp) (`agencyhandy-mcp@1.5+`):
...
See [Client Custom Fields](/fi/crm/client-custom-fields) for defining client-side fields.
...
- [Leads](/fi/crm/leads) — pipeline, email, and conversion
- [Client Custom Fields](/fi/crm/client-custom-fields) — fields that appear on client profiles
- [Clients](/fi/crm/clients) — client list, import, and portal access
- [Claude & Cursor MCP](/fi/integrations/claude-cursor-mcp) — fill fields from AI tools
