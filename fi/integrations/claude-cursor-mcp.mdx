...
description: "Määritä AgencyHandyn MCP-paketti, jotta voit pyytää Claude Desktopia tai Cursoria briefingiin, tikettien määritykseen, laskujen lähetykseen ja muuhun — arkikielellä."
---

AgencyHandyn MCP-yhteys antaa puhua **Claudelle** tai **Cursorille** arkikielellä ja suorittaa päivittäistä työtä AgencyHandy-työtilassa — ilman että avaat jokaista näyttöä itse.
