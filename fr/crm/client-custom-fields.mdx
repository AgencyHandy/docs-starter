...
See [Lead Custom Fields](/fr/crm/lead-custom-fields) for defining lead-side fields.
...
- [Clients](/fr/crm/clients) — create, import, export, and portal access
- [Lead Custom Fields](/fr/crm/lead-custom-fields) — fields on prospects before conversion
- [Leads](/fr/crm/leads) — pipeline and convert to client
