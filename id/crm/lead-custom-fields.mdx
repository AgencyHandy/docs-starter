---
title: "Bidang kustom lead: tangkap data prospek ekstra"
sidebarTitle: "Bidang kustom lead"
description: "Buat dan kelola bidang kustom lead di Workspace Config."
---
...
With [AgencyHandy MCP](/id/integrations/claude-cursor-mcp) (`agencyhandy-mcp@1.5+`):
...
See [Client Custom Fields](/id/crm/client-custom-fields) for defining client-side fields.
...
- [Leads](/id/crm/leads) — pipeline, email, and conversion
- [Client Custom Fields](/id/crm/client-custom-fields) — fields that appear on client profiles
- [Clients](/id/crm/clients) — client list, import, and portal access
- [Claude & Cursor MCP](/id/integrations/claude-cursor-mcp) — fill fields from AI tools
