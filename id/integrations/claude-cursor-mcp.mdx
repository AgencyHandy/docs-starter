...
description: "Siapkan paket MCP AgencyHandy agar Anda dapat meminta Claude Desktop atau Cursor untuk briefing, menetapkan tiket, mengirim invoice, dan lainnya — dengan bahasa sehari-hari."
---

Koneksi MCP AgencyHandy memungkinkan Anda berbicara dengan **Claude** atau **Cursor** dalam bahasa sehari-hari dan menjalankan pekerjaan harian di workspace AgencyHandy — tanpa membuka setiap layar sendiri.
