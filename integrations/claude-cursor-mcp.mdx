...
<Note>
  You need a role that can open **Workspace Config** and manage **API keys** (typically **SuperAdmin** or **Admin**). You also need **Node.js 20+** installed on the computer where Claude Desktop or Cursor runs. Use `agencyhandy-mcp@1` (**1.6+** for advanced context packs).
</Note>
...
| **MCP package** | `npx -y agencyhandy-mcp@1` (advanced context from **1.6.0**) |
