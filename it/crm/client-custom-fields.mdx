---
title: "Campi personalizzati client: monitora dettagli client extra"
sidebarTitle: "Campi personalizzati client"
description: "Crea e gestisci campi personalizzati per i client in Workspace Config."
---
...
With [AgencyHandy MCP](/it/integrations/claude-cursor-mcp) (`agencyhandy-mcp@1.5+`):
...
See [Lead Custom Fields](/it/crm/lead-custom-fields) for defining lead-side fields.
...
- [Clients](/it/crm/clients) — create, import, export, and portal access
- [Lead Custom Fields](/it/crm/lead-custom-fields) — fields on prospects before conversion
- [Leads](/it/crm/leads) — pipeline and convert to client
- [Claude & Cursor MCP](/it/integrations/claude-cursor-mcp) — fill fields from AI tools
