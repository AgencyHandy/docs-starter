---
title: "Campi personalizzati lead: cattura dati prospect extra"
sidebarTitle: "Campi personalizzati lead"
description: "Crea e gestisci campi personalizzati per i lead in Workspace Config."
---
...
See [Client Custom Fields](/it/crm/client-custom-fields) for defining client-side fields.
...
- [Leads](/it/crm/leads) — pipeline, email, and conversion
- [Client Custom Fields](/it/crm/client-custom-fields) — fields that appear on client profiles
- [Clients](/it/crm/clients) — client list, import, and portal access
