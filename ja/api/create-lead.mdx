...
<Note>
  Before using this endpoint, complete the [Getting Started](/ja/api/getting-started) guide to obtain your API key. You do not need to send a company ID or role ID. AgencyHandy assigns the lead to the workspace client role automatically.
</Note>
