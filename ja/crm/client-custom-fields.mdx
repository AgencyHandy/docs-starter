---
title: "クライアントカスタムフィールド：追加のクライアント詳細を記録"
sidebarTitle: "クライアントカスタムフィールド"
description: "Workspace Config でクライアント用カスタムフィールドを作成・管理し、契約条件、業種タグ、希望連絡手段など標準プロフィール以外のデータを保存します。"
---
...
With [AgencyHandy MCP](/ja/integrations/claude-cursor-mcp) (`agencyhandy-mcp@1.5+`):
...
See [Lead Custom Fields](/ja/crm/lead-custom-fields) for defining lead-side fields.
...
- [Clients](/ja/crm/clients) — create, import, export, and portal access
- [Lead Custom Fields](/ja/crm/lead-custom-fields) — fields on prospects before conversion
- [Leads](/ja/crm/leads) — pipeline and convert to client
- [Claude & Cursor MCP](/ja/integrations/claude-cursor-mcp) — fill fields from AI tools
