---
title: "リードカスタムフィールド：追加の見込み客データを記録"
sidebarTitle: "リードカスタムフィールド"
description: "Workspace Config でリード用カスタムフィールドを作成・管理し、業種、予算、流入元など標準 CRM 項目以外のデータをチームで追跡します。"
---
...
See [Client Custom Fields](/ja/crm/client-custom-fields) for defining client-side fields.
...
- [Leads](/ja/crm/leads) — pipeline, email, and conversion
- [Client Custom Fields](/ja/crm/client-custom-fields) — fields that appear on client profiles
- [Clients](/ja/crm/clients) — client list, import, and portal access
