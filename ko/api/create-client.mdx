...
<Note>
  Before using this endpoint, complete the [Getting Started](/ko/api/getting-started) guide to obtain your API key. You do not need to send a company ID or role ID. AgencyHandy assigns the client to the workspace client role automatically.
</Note>
