---
title: "클라이언트 커스텀 필드: 추가 클라이언트 정보 추적"
sidebarTitle: "클라이언트 커스텀 필드"
description: "Workspace Config에서 클라이언트 커스텀 필드를 만들고 관리해 계약 조건, 업종 태그, 선호 연락 수단 등 기본 프로필 밖의 데이터를 저장하세요."
---
...
With [AgencyHandy MCP](/ko/integrations/claude-cursor-mcp) (`agencyhandy-mcp@1.5+`):
...
See [Lead Custom Fields](/ko/crm/lead-custom-fields) for defining lead-side fields.
...
- [Clients](/ko/crm/clients) — create, import, export, and portal access
- [Lead Custom Fields](/ko/crm/lead-custom-fields) — fields on prospects before conversion
- [Leads](/ko/crm/leads) — pipeline and convert to client
- [Claude & Cursor MCP](/ko/integrations/claude-cursor-mcp) — fill fields from AI tools
