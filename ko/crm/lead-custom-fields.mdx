---
title: "리드 커스텀 필드: 추가 잠재고객 데이터 수집"
sidebarTitle: "리드 커스텀 필드"
description: "Workspace Config에서 리드 커스텀 필드를 만들고 관리해 팀에서 업종, 예산, 유입 경로 등 기본 CRM 필드 밖의 데이터를 추적하세요."
---
...
See [Client Custom Fields](/ko/crm/client-custom-fields) for defining client-side fields.
...
- [Leads](/ko/crm/leads) — pipeline, email, and conversion
- [Client Custom Fields](/ko/crm/client-custom-fields) — fields that appear on client profiles
- [Clients](/ko/crm/clients) — client list, import, and portal access
