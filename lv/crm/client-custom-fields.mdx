---
title: "Client pielāgotie lauki: papildu client informācija"
sidebarTitle: "Client pielāgotie lauki"
description: "Izveidojiet un pārvaldiet client pielāgotos laukus Workspace Config."
---
...
With [AgencyHandy MCP](/lv/integrations/claude-cursor-mcp) (`agencyhandy-mcp@1.5+`):
...
See [Lead Custom Fields](/lv/crm/lead-custom-fields) for defining lead-side fields.
...
- [Clients](/lv/crm/clients) — create, import, export, and portal access
- [Lead Custom Fields](/lv/crm/lead-custom-fields) — fields on prospects before conversion
- [Leads](/lv/crm/leads) — pipeline and convert to client
- [Claude & Cursor MCP](/lv/integrations/claude-cursor-mcp) — fill fields from AI tools
