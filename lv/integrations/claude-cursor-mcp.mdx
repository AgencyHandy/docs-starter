...
description: "Iestatiet AgencyHandy MCP pakotni, lai Claude Desktop vai Cursor varētu lūgt brīfingu, piešķirt biļetes, sūtīt rēķinus un vairāk — ikdienas valodā."
---

AgencyHandy MCP savienojums ļauj runāt ar **Claude** vai **Cursor** ikdienas valodā un veikt ikdienas darbu AgencyHandy darba telpā — neatverot katru ekrānu pašam.
...
## Iestatiet Claude vai Cursor MCP
...
## Kad diviem cilvēkiem ir vienāds vārds
