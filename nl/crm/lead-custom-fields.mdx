---
title: "Lead-aangepaste velden: leg extra prospectgegevens vast"
sidebarTitle: "Lead-aangepaste velden"
description: "Maak en beheer aangepaste velden voor leads in Workspace Config."
---
...
With [AgencyHandy MCP](/nl/integrations/claude-cursor-mcp) (`agencyhandy-mcp@1.5+`):
...
See [Client Custom Fields](/nl/crm/client-custom-fields) for defining client-side fields.
...
- [Leads](/nl/crm/leads) — pipeline, email, and conversion
- [Client Custom Fields](/nl/crm/client-custom-fields) — fields that appear on client profiles
- [Clients](/nl/crm/clients) — client list, import, and portal access
- [Claude & Cursor MCP](/nl/integrations/claude-cursor-mcp) — fill fields from AI tools
