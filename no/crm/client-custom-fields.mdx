---
title: "Client egendefinerte felt: spor ekstra client-detaljer"
sidebarTitle: "Client egendefinerte felt"
description: "Opprett og administrer egendefinerte felt for clients i Workspace Config."
---
...
With [AgencyHandy MCP](/no/integrations/claude-cursor-mcp) (`agencyhandy-mcp@1.5+`):
...
See [Lead Custom Fields](/no/crm/lead-custom-fields) for defining lead-side fields.
...
- [Clients](/no/crm/clients) — create, import, export, and portal access
- [Lead Custom Fields](/no/crm/lead-custom-fields) — fields on prospects before conversion
- [Leads](/no/crm/leads) — pipeline and convert to client
- [Claude & Cursor MCP](/no/integrations/claude-cursor-mcp) — fill fields from AI tools
