---
title: "Lead egendefinerte felt: fang ekstra prospekt-data"
sidebarTitle: "Lead egendefinerte felt"
description: "Opprett og administrer egendefinerte felt for leads i Workspace Config."
---
...
See [Client Custom Fields](/no/crm/client-custom-fields) for defining client-side fields.
...
- [Leads](/no/crm/leads) — pipeline, email, and conversion
- [Client Custom Fields](/no/crm/client-custom-fields) — fields that appear on client profiles
- [Clients](/no/crm/clients) — client list, import, and portal access
