---
title: "Koble til Claude og Cursor for å kjøre AgencyHandy med MCP"
sidebarTitle: "Claude & Cursor MCP"
description: "Sett opp AgencyHandys MCP-pakke slik at du kan be Claude Desktop eller Cursor om briefing, tildele tickets, sende fakturaer med mer — på vanlig språk."
---

AgencyHandys MCP-tilkobling lar deg snakke med **Claude** eller **Cursor** på vanlig språk og kjøre daglig arbeid i AgencyHandy-workspacet — uten å åpne hver skjerm selv.
