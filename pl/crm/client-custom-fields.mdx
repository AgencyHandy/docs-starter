---
title: "Pola niestandardowe klientów: śledź dodatkowe szczegóły"
sidebarTitle: "Pola niestandardowe klientów"
description: "Twórz i zarządzaj polami niestandardowymi klientów w Workspace Config."
---
...
With [AgencyHandy MCP](/pl/integrations/claude-cursor-mcp) (`agencyhandy-mcp@1.5+`):
...
See [Lead Custom Fields](/pl/crm/lead-custom-fields) for defining lead-side fields.
...
- [Clients](/pl/crm/clients) — create, import, export, and portal access
- [Lead Custom Fields](/pl/crm/lead-custom-fields) — fields on prospects before conversion
- [Leads](/pl/crm/leads) — pipeline and convert to client
- [Claude & Cursor MCP](/pl/integrations/claude-cursor-mcp) — fill fields from AI tools
