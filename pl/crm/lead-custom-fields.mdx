---
title: "Pola niestandardowe leadów: zbieraj dodatkowe dane"
sidebarTitle: "Pola niestandardowe leadów"
description: "Twórz i zarządzaj polami niestandardowymi leadów w Workspace Config."
---
...
See [Client Custom Fields](/pl/crm/client-custom-fields) for defining client-side fields.
...
- [Leads](/pl/crm/leads) — pipeline, email, and conversion
- [Client Custom Fields](/pl/crm/client-custom-fields) — fields that appear on client profiles
- [Clients](/pl/crm/clients) — client list, import, and portal access
