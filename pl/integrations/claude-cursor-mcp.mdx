...
Połączenie MCP AgencyHandy pozwala rozmawiać z **Claude** lub **Cursor** w naturalnym języku i wykonywać codzienną pracę w workspace AgencyHandy — bez otwierania każdego ekranu.
...
## Skonfiguruj Claude lub Cursor MCP
