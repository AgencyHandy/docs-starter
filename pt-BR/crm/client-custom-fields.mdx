---
title: "Campos personalizados de clients: acompanhe detalhes extras"
sidebarTitle: "Campos personalizados de clients"
description: "Crie e gerencie campos personalizados de clients no Workspace Config."
---
...
With [AgencyHandy MCP](/pt-BR/integrations/claude-cursor-mcp) (`agencyhandy-mcp@1.5+`):
...
See [Lead Custom Fields](/pt-BR/crm/lead-custom-fields) for defining lead-side fields.
...
- [Clients](/pt-BR/crm/clients) — create, import, export, and portal access
- [Lead Custom Fields](/pt-BR/crm/lead-custom-fields) — fields on prospects before conversion
- [Leads](/pt-BR/crm/leads) — pipeline and convert to client
- [Claude & Cursor MCP](/pt-BR/integrations/claude-cursor-mcp) — fill fields from AI tools
