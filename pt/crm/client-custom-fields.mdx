---
title: "Campos personalizados de clients: acompanhe detalhes extra"
sidebarTitle: "Campos personalizados de clients"
description: "Crie e gira campos personalizados de clients no Workspace Config."
---
...
With [AgencyHandy MCP](/pt/integrations/claude-cursor-mcp) (`agencyhandy-mcp@1.5+`):
...
See [Lead Custom Fields](/pt/crm/lead-custom-fields) for defining lead-side fields.
...
- [Clients](/pt/crm/clients) — create, import, export, and portal access
- [Lead Custom Fields](/pt/crm/lead-custom-fields) — fields on prospects before conversion
- [Leads](/pt/crm/leads) — pipeline and convert to client
- [Claude & Cursor MCP](/pt/integrations/claude-cursor-mcp) — fill fields from AI tools
