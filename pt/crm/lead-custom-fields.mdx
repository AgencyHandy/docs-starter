---
title: "Campos personalizados de leads: capture dados extra"
sidebarTitle: "Campos personalizados de leads"
description: "Crie e gira campos personalizados de leads no Workspace Config."
---
...
See [Client Custom Fields](/pt/crm/client-custom-fields) for defining client-side fields.
...
- [Leads](/pt/crm/leads) — pipeline, email, and conversion
- [Client Custom Fields](/pt/crm/client-custom-fields) — fields that appear on client profiles
- [Clients](/pt/crm/clients) — client list, import, and portal access
