---
title: "Câmpuri personalizate client: urmăriți detalii client suplimentare"
sidebarTitle: "Câmpuri personalizate client"
description: "Creați și gestionați câmpuri personalizate pentru clienți în Workspace Config."
---
...
See [Lead Custom Fields](/ro/crm/lead-custom-fields) for defining lead-side fields.
...
- [Clients](/ro/crm/clients) — create, import, export, and portal access
- [Lead Custom Fields](/ro/crm/lead-custom-fields) — fields on prospects before conversion
- [Leads](/ro/crm/leads) — pipeline and convert to client
