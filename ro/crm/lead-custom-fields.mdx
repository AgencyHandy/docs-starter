---
title: "Câmpuri personalizate lead: capturați date prospect suplimentare"
sidebarTitle: "Câmpuri personalizate lead"
description: "Creați și gestionați câmpuri personalizate pentru lead-uri în Workspace Config."
---
...
With [AgencyHandy MCP](/ro/integrations/claude-cursor-mcp) (`agencyhandy-mcp@1.5+`):
...
See [Client Custom Fields](/ro/crm/client-custom-fields) for defining client-side fields.
...
- [Leads](/ro/crm/leads) — pipeline, email, and conversion
- [Client Custom Fields](/ro/crm/client-custom-fields) — fields that appear on client profiles
- [Clients](/ro/crm/clients) — client list, import, and portal access
- [Claude & Cursor MCP](/ro/integrations/claude-cursor-mcp) — fill fields from AI tools
