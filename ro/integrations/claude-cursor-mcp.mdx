---
title: "Conectați Claude și Cursor pentru a folosi AgencyHandy cu MCP"
sidebarTitle: "Claude și Cursor MCP"
description: "Configurați pachetul MCP AgencyHandy ca să cereți Claude Desktop sau Cursor un briefing, asignarea ticketelor, trimiterea facturilor și altele — în limbaj natural."
---

Conexiunea MCP AgencyHandy vă permite să vorbiți cu **Claude** sau **Cursor** în limbaj natural și să rulați munca zilnică în workspace-ul AgencyHandy — fără să deschideți fiecare ecran.
...
## Configurați Claude sau Cursor MCP
