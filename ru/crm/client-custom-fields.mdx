---
title: "Пользовательские поля клиентов: дополнительные сведения"
sidebarTitle: "Пользовательские поля клиентов"
description: "Создавайте и управляйте пользовательскими полями клиентов в Workspace Config."
---
...
See [Lead Custom Fields](/ru/crm/lead-custom-fields) for defining lead-side fields.
...
- [Clients](/ru/crm/clients) — create, import, export, and portal access
- [Lead Custom Fields](/ru/crm/lead-custom-fields) — fields on prospects before conversion
- [Leads](/ru/crm/leads) — pipeline and convert to client
