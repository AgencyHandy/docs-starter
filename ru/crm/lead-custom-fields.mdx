---
title: "Пользовательские поля лидов: дополнительные данные по prospect"
sidebarTitle: "Пользовательские поля лидов"
description: "Создавайте и управляйте пользовательскими полями лидов в Workspace Config."
---
...
With [AgencyHandy MCP](/ru/integrations/claude-cursor-mcp) (`agencyhandy-mcp@1.5+`):
...
See [Client Custom Fields](/ru/crm/client-custom-fields) for defining client-side fields.
...
- [Leads](/ru/crm/leads) — pipeline, email, and conversion
- [Client Custom Fields](/ru/crm/client-custom-fields) — fields that appear on client profiles
- [Clients](/ru/crm/clients) — client list, import, and portal access
- [Claude & Cursor MCP](/ru/integrations/claude-cursor-mcp) — fill fields from AI tools
