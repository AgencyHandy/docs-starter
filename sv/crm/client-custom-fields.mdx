---
title: "Client-anpassade fält: spåra extra client-detaljer"
sidebarTitle: "Client-anpassade fält"
description: "Skapa och hantera anpassade fält för clients i Workspace Config."
---
...
With [AgencyHandy MCP](/sv/integrations/claude-cursor-mcp) (`agencyhandy-mcp@1.5+`):
...
See [Lead Custom Fields](/sv/crm/lead-custom-fields) for defining lead-side fields.
...
- [Clients](/sv/crm/clients) — create, import, export, and portal access
- [Lead Custom Fields](/sv/crm/lead-custom-fields) — fields on prospects before conversion
- [Leads](/sv/crm/leads) — pipeline and convert to client
- [Claude & Cursor MCP](/sv/integrations/claude-cursor-mcp) — fill fields from AI tools
