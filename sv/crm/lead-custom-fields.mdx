---
title: "Lead-anpassade fält: samla extra prospekt-data"
sidebarTitle: "Lead-anpassade fält"
description: "Skapa och hantera anpassade fält för leads i Workspace Config."
---
...
See [Client Custom Fields](/sv/crm/client-custom-fields) for defining client-side fields.
...
- [Leads](/sv/crm/leads) — pipeline, email, and conversion
- [Client Custom Fields](/sv/crm/client-custom-fields) — fields that appear on client profiles
- [Clients](/sv/crm/clients) — client list, import, and portal access
