...
description: "Konfigurera AgencyHandys MCP-paket så att du kan be Claude Desktop eller Cursor om briefing, tilldela ärenden, skicka fakturor med mera — på vardagsspråk."
---

AgencyHandys MCP-anslutning låter dig prata med **Claude** eller **Cursor** på vardagsspråk och köra dagligt arbete i din AgencyHandy-workspace — utan att öppna varje skärm själv.
...
## När två personer har samma namn
