---
title: "Lead özel alanları: ekstra potansiyel müşteri verisi"
sidebarTitle: "Lead özel alanları"
description: "Workspace Config içinde lead özel alanlarını oluşturun ve yönetin."
---
...
See [Client Custom Fields](/tr/crm/client-custom-fields) for defining client-side fields.
...
- [Leads](/tr/crm/leads) — pipeline, email, and conversion
- [Client Custom Fields](/tr/crm/client-custom-fields) — fields that appear on client profiles
- [Clients](/tr/crm/clients) — client list, import, and portal access
