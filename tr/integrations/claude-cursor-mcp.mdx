---
title: "AgencyHandy’yi MCP ile çalıştırmak için Claude ve Cursor’ı bağlayın"
sidebarTitle: "Claude ve Cursor MCP"
description: "AgencyHandy MCP paketini kurun; Claude Desktop veya Cursor’a doğal dilde brifing, ticket atama, fatura gönderme ve daha fazlasını isteyin."
---

AgencyHandy’nin MCP bağlantısı, **Claude** veya **Cursor** ile doğal dilde konuşup AgencyHandy çalışma alanındaki günlük işleri çalıştırmanıza olanak tanır — her ekranı kendiniz açmadan.
...
## Şimdi ne çalışıyor vs henüz değil
