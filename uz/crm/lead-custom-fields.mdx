---
title: "Lead maxsus maydonlari: qo‘shimcha prospect ma’lumotlari"
sidebarTitle: "Lead maxsus maydonlari"
description: "Workspace Config’da lead maxsus maydonlarini yarating va boshqaring."
---
...
With [AgencyHandy MCP](/uz/integrations/claude-cursor-mcp) (`agencyhandy-mcp@1.5+`):
...
See [Client Custom Fields](/uz/crm/client-custom-fields) for defining client-side fields.
...
- [Leads](/uz/crm/leads) — pipeline, email, and conversion
- [Client Custom Fields](/uz/crm/client-custom-fields) — fields that appear on client profiles
- [Clients](/uz/crm/clients) — client list, import, and portal access
- [Claude & Cursor MCP](/uz/integrations/claude-cursor-mcp) — fill fields from AI tools
