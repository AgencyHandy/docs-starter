---
title: "客戶自訂欄位：追蹤額外客戶詳情"
sidebarTitle: "客戶自訂欄位"
description: "在 Workspace Config 中為客戶建立與管理自訂欄位，以擷取合約條款、產業標籤、偏好聯絡方式等超出預設資料的內容。"
---
...
See [Lead Custom Fields](/zh-Hant/crm/lead-custom-fields) for defining lead-side fields.
...
- [Clients](/zh-Hant/crm/clients) — create, import, export, and portal access
- [Lead Custom Fields](/zh-Hant/crm/lead-custom-fields) — fields on prospects before conversion
- [Leads](/zh-Hant/crm/leads) — pipeline and convert to client
