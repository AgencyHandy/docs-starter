---
title: "客户自定义字段：跟踪额外客户详情"
sidebarTitle: "客户自定义字段"
description: "在 Workspace Config 中为客户创建和管理自定义字段，以捕获合同条款、行业标签、首选联系方式等超出默认资料的数据。"
---
...
See [Lead Custom Fields](/zh/crm/lead-custom-fields) for defining lead-side fields.
...
- [Clients](/zh/crm/clients) — create, import, export, and portal access
- [Lead Custom Fields](/zh/crm/lead-custom-fields) — fields on prospects before conversion
- [Leads](/zh/crm/leads) — pipeline and convert to client
