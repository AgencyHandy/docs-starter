---
title: "线索自定义字段：捕获额外潜客数据"
sidebarTitle: "线索自定义字段"
description: "在 Workspace Config 中为线索创建和管理自定义字段，以便团队跟踪行业、预算、来源等超出默认 CRM 字段的数据。"
---
...
With [AgencyHandy MCP](/zh/integrations/claude-cursor-mcp) (`agencyhandy-mcp@1.5+`):
...
See [Client Custom Fields](/zh/crm/client-custom-fields) for defining client-side fields.
...
- [Leads](/zh/crm/leads) — pipeline, email, and conversion
- [Client Custom Fields](/zh/crm/client-custom-fields) — fields that appear on client profiles
- [Clients](/zh/crm/clients) — client list, import, and portal access
- [Claude & Cursor MCP](/zh/integrations/claude-cursor-mcp) — fill fields from AI tools
